...
static Map<String, WidgetBuilder> get routes =>  {flashScreen : FlashScreen.builder, onboardingScreen : OnboardingScreen.builder, onboardingOneScreen : OnboardingOneScreen.builder, onboardingTwoScreen : OnboardingTwoScreen.builder, loginScreen : LoginScreen.builder, loginWithScreen : LoginWithScreen.builder, signupScreen : SignupScreen.builder, signupOneScreen : SignupOneScreen.builder, loginOneScreen : LoginOneScreen.builder, chooseScreen : ChooseScreen.builder, livingRoomScreen : LivingRoomScreen.builder, kitchenRoomScreen : KitchenRoomScreen.builder, homeScreen : HomeScreen.builder, roomsviewAllScreen : RoomsviewAllScreen.builder, temperaturScreen : TemperaturScreen.builder, tvScreen : TvScreen.builder, lightScreen : LightScreen.builder, windowTabContainerScreen : WindowTabContainerScreen.builder, musicScreen : MusicScreen.builder, playlistMusicScreen : PlaylistMusicScreen.builder, analysContainerScreen : AnalysContainerScreen.builder, connectScreen : ConnectScreen.builder, connectingScreen : ConnectingScreen.builder, connectedScreen : ConnectedScreen.builder, historyScreen : HistoryScreen.builder, profileScreen : ProfileScreen.builder, familyAccessScreen : FamilyAccessScreen.builder, personalInfoScreen : PersonalInfoScreen.builder, iphone11ProXFortytwoScreen : Iphone11ProXFortytwoScreen.builder, loginPageScreen : LoginPageScreen.builder, appNavigationScreen : AppNavigationScreen.builder, initialRoute : FlashScreen.builder};
 }
