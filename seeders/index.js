...
async function seedUser () {
  try {
    ...
    userToBeInserted = {
      ...
      'isDeleted':false,
      'username':'Laron68',
      'email':'Johnnie54@gmail.com',
      'isActive':true,
      'userType':authConstant.USER_TYPES.User
    };
    userToBeInserted.password = await  bcrypt.hash(userToBeInserted.password, 8);
    let user = await dbService.updateOne(User, { 'username':'Laron68' }, userToBeInserted,  { upsert: true });
    userToBeInserted = {
      'password':'WMdHr6w6jbJL3yI',
      'isDeleted':false,
      'username':'Era20',
      'email':'Aron_Kuhn86@yahoo.com',
      'isActive':true,
      'userType':authConstant.USER_TYPES.Admin
    };
    userToBeInserted.password = await  bcrypt.hash(userToBeInserted.password, 8);
    let admin = await dbService.updateOne(User, { 'username':'Era20' }, userToBeInserted,  { upsert: true });
