...
const TableListPage = () => {
  ...
  return (
    <>
      <div className="bg-white-A700 flex flex-col font-salsa items-center justify-start mx-auto pb-[5px] w-full">
        <div className="flex md:flex-col flex-row md:gap-5 items-start justify-evenly w-full">
          ...
          <div className="flex md:flex-1 flex-col font-roboto gap-[38px] items-center justify-start md:px-5 w-[83%] md:w-full">
            ...
            <div className="flex flex-col items-start justify-start w-[94%] md:w-full">
              ...
              <div className="bg-white-A700 flex flex-col gap-9 items-start justify-start mt-[39px] p-[25px] sm:px-5 rounded-[15px] shadow-bs3 w-full">
                <div className="flex md:flex-col flex-row md:gap-5 items-start justify-start mt-1 w-[87%] md:w-full">
                  <Text
                  ...
                  <Text
                    className="font-medium md:ml-[0] ml-[60px] text-gray-700 text-sm"
                    size="textlg"
                  >
                    Book Date
                  </Text>
                  ...
                  <Text
                    className="font-medium ml-32 md:ml-[0] text-gray-700 text-sm"
                    size="textlg"
                  >
                    Table Floor
                  </Text>
                  <Text
                    className="font-medium md:ml-[0] ml-[121px] md:mt-0 mt-0.5 text-gray-700 text-sm"
                    size="textlg"
                  >
                    Amount
                  </Text>
                ...
                <List
                  className="flex flex-col gap-[14.485px] items-center mb-[3px] w-full"
                  orientation="vertical"
                >
                  <div className="flex flex-1 sm:flex-col flex-row sm:gap-5 items-center justify-start w-full">
                    ...
                    <Text
                      className="font-medium sm:ml-[0] ml-[61px] text-gray-700 text-sm"
                      size="textlg"
                    >
                      Double Table
                    </Text>
                    <Text
                      className="font-medium sm:ml-[0] ml-[114px] text-gray-700 text-sm"
                      size="textlg"
                    >
                      Floor G-05
                    </Text>
                    <Text
                      className="font-medium sm:ml-[0] ml-[125px] text-gray-700 text-sm"
                      size="textlg"
                    >
                      $82.48
                    </Text>
                  ...
                  <div className="flex flex-1 sm:flex-col flex-row sm:gap-5 items-center justify-start w-full">
                    ...
                    <Text
                      className="font-medium sm:ml-[0] ml-[119px] text-gray-700 text-sm"
                      size="textlg"
                    >
                      Floor G-04
                    </Text>
                    ...
                    <Button className="bg-blue-50 cursor-pointer font-medium min-w-[99px] sm:ml-[0] ml-[95px] py-[7px] rounded-sm text-blue-A201 text-center text-sm">
                      Booked
                    </Button>
                    <Img
                      className="h-1 sm:ml-[0] ml-[90px] w-[2%]"
                  ...
                  <div className="flex flex-1 sm:flex-col flex-row sm:gap-5 items-center justify-start w-full">
                    ...
                    <Text
                      className="font-medium sm:ml-[0] ml-[120px] text-gray-700 text-sm"
                      size="textlg"
                    >
                      Floor S-03
                    </Text>
                    <Text
                      className="font-medium sm:ml-[0] ml-[126px] text-gray-700 text-xs"
                      size="textmd"
                    >
                      $82.46{" "}
                    </Text>
                  ...
                  <div className="flex flex-1 sm:flex-col flex-row sm:gap-5 items-center justify-start w-full">
                    ...
                    <Text
                      className="font-medium sm:ml-[0] ml-[126px] text-gray-700 text-sm"
                      size="textlg"
                    >
                      $87.46
                    </Text>
                  ...
                  <div className="flex flex-1 sm:flex-col flex-row sm:gap-5 items-center justify-start w-full">
                    ...
                    <Text
                      className="font-medium sm:ml-[0] ml-[115px] text-gray-700 text-sm"
                      size="textlg"
                    >
                      Floor S-03
                    </Text>
                    ...
                    <Text
                      className="bg-blue-50 font-medium h-[31px] justify-center sm:ml-[0] ml-[94px] sm:pl-5 pl-[26px] py-[7px] rounded-sm text-green-50 text-sm"
                      size="textlg"
                    >
                  ...
                  <div className="flex flex-1 sm:flex-col flex-row sm:gap-5 items-center justify-start w-full">
                    ...
                    <Text
                      className="bg-green-50 font-medium h-[31px] justify-center sm:ml-[0] ml-[94px] sm:pl-5 pl-[21px] py-[7px] rounded-sm text-gray-500 text-sm"
                      size="textlg"
                    >
